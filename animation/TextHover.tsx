	...
	return (
		<div className="group flex gap-x-[20px] overflow-hidden cursor-pointer transition-all ease-in-out duration-200">
			<div className="relative transition-all ease-in-out duration-500">
				<div className="">
					<h1 className="text-[20px] md:text-[3px] lg:text-[35px] translate-y-[-100%] group-hover:translate-y-[0%] absolute  left-0 transition-all ease-in-out duration-500 flex">
						<div className="translate-y-[-100%] group-hover:translate-y-[0%] transition-all ease-in-out duration-500">
							{titile1}
						</div>
					</h1>
					<h1 className="text-[20px] md:text-[3px] lg:text-[35px] relative flex gap-x-[7px] transition-all ease-in-out duration-500">
					...
					<h1 className="flex gap-x-[7px] text-[20px] md:text-[3px] lg:text-[35px] absolute translate-y-[100%] group-hover:translate-y-[-100%] right-0 transition-all ease-in-out duration-500">
						<div className="translate-y-[100%] group-hover:translate-y-[0%] transition-all ease-in-out duration-500">
							{subTitle1}
						</div>
					</h1>
